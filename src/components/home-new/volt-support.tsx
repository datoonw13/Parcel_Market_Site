...
const VoltSupport = ({ user }: { user: IUserBaseInfo | null }) => {
  ...
  return (
    <div
      className="px-5 py-12 sm:py-14 md:py-20 lg:py-24  mt-16 md:mt-20 lg:mt-24"
      style={{ background: "linear-gradient(101.53deg, #0E8B40 16.59%, #16DB65 144.19%)" }}
    >
      <div className="max-w-7xl mx-auto lg:px-8 xl:px-20 grid lg:grid-cols-2 gap-y-11 gap-x-[5vw]">
