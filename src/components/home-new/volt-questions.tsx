...
const VoltQuestions = () => (
  <div className="bg-[#F9F9F9] py-8 md:py-10 lg:py-16">
    <div className="max-w-7xl mx-auto px-4 lg:px-8 xl:px-20 mb-8 lg:mb-11 flex flex-col gap-6 md:gap-8 lg:gap-11">
      <div className="px-2 space-y-2">
        <h1 className="text-start md:text-center font-extrabold text-2xl">Frequently asked questions</h1>
        <h2 className="text-start md:text-center font-light">
      ...
      <Accordion type="single" collapsible className="w-full space-y-3 md:space-y-4">
        {list.map((el, i) => (
          <AccordionItem
            className="bg-white border border-[#D5D3D3] rounded-2xl px-5 md:px-7 lg:px-10 "
            key={el.title}
            value={i.toString()}
          >
        ...
        <AccordionItem className="bg-white border border-[#D5D3D3] rounded-2xl px-5 md:px-7 lg:px-10  relative" disabled value="no">
          ...
          <AccordionContent>
            Our testers, who are real estate professionals in the land business, can research on average 10 vacant land parcels in the time
            it would typically take to analyze 2, using traditional methods. This substantial time saving enhances productivity, allowing
            you to explore more opportunities and make informed decisions much faster, leading to an increased deal flow and better
            understanding of vacant land markets.
          </AccordionContent>
