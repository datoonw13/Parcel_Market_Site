...
const CalculationTerms = ({ onValueChange, className }: { onValueChange: (value: boolean) => void; className?: string }) => (
  <div className={cn("space-y-6 bg-white h-full", className)} style={{ perspective: 1 }}>
