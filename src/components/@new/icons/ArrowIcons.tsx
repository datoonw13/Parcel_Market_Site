...
export const ArrowIconLeft1 = ({ className }: { className?: string }) => (
  <svg className={clsx("fill-black w-4 h-4", className)} viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowIconRight1 = ({ className }: { className?: string }) => (
  <svg className={clsx("fill-black w-4 h-4", className)} viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
