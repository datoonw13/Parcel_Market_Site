...
export const ArrowIconDown1 = ({ className, strokeWidth = 1.5, color = 'black' }: { className?: string; strokeWidth?: number, color?: string }) => (
  <svg aria-color="stroke" className={clsx("w-4 h-4", `stroke-${color}`, className)} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      strokeLinecap="round"
...
export const ArrowIconUp1 = ({ className, strokeWidth = 1.5, color = 'black' }: { className?: string; strokeWidth?: number, color?: string })  => (
  <svg aria-color="stroke" className={clsx("w-4 h-4", `stroke-${color}`, className)} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ArrowIconLeft1 = ({ className, color = 'black' }: { className?: string, color?: string }) => (
  <svg aria-color="fill" className={clsx("w-4 h-4", `stroke-${color}`, className)} viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ArrowIconsUnion1 = ({ className, color = 'black' }: { className?: string, color?: string })  => (
  <svg aria-color="fill" className={clsx("w-4 h-4", `stroke-${color}`, className)}  viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
