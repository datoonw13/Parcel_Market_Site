...
export const InfoIcon2 = ({ className, color = "black" }: { className?: string; color?: string }) => (
  <svg aria-label="fill" className={clsx("w-4 h-4", className)} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="10" cy="10" r="9" className={`stroke-${color}`} strokeWidth="2" />
    <circle cx="10" cy="15.3057" r="1" className={`fill-${color}`} />
    <rect x="9" y="4" width="2" height="9" rx="1" className={`fill-${color}`} />
  </svg>
);
