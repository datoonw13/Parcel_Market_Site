...
export const GoogleIcon1 = ({ className }: { className?: string }) => (
  <svg className={clsx("w-6 h-6", className)} viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect transform="translate(0.5)" fill="white" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12.4995 23.4996C15.6045 23.4996 18.2077 22.4698 20.1104 20.7134L16.3938 17.828C15.364 18.518 14.0467 18.9257 12.4995 18.9257C9.50425 18.9257 6.96902 16.9028 6.0647 14.1846H2.22266V17.1641C4.11493 20.9225 8.00402 23.4996 12.4995 23.4996Z"
      fill="#0E8B40"
    />
    <path
      fillRule="evenodd"
