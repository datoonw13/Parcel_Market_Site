...
// import { getCounties, getCounty } from "@/helpers/states";
...
//   const selectedValue =
//     filterKey === "county"
//       ? getCounty(params.get("county"), params.get("state"))
...
const AutoCompleteDesktopFilters = () => <div>AutoCompleteDesktopFilters</div>;
