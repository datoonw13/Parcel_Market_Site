...
const UserListingPagination = ({ totalCount }: { totalCount: number }) => {
  ...
  return Math.ceil(totalCount / PAGE_SIZE) < 2 ? null : <Pagination initialPage={page - 1} rowsPerPage={PAGE_SIZE} totalCount={totalCount} className="mt-12" onChange={handleChange} />;
};
