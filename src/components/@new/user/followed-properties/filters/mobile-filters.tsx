...
// interface UserFollowedPropertiesMobileFiltersProps {
//   disabled?: boolean;
//   selectedFilters: Filters;
//   onChange: <T extends keyof Filters>(data: { [key in T]: Filters[T] }) => void;
// }
// const UserFollowedPropertiesMobileFilters: FC<UserFollowedPropertiesMobileFiltersProps> = ({ disabled, selectedFilters, onChange }) => {
...
// export default UserFollowedPropertiesMobileFilters;

import React from "react";

const MbF = () => <div>MbF</div>;
