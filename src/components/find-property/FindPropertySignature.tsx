  ...
  <Box sx={{ height: "100%", display: "flex", flexDirection: "column", mt: { xs: 1, md: 0 }, overflow: "hidden" }}>
    <Box sx={{ px: { xs: 2, md: 3, lg: 4, mb: 3 }, height: "100%" }}>
      <Box sx={{ bgcolor: "green.100", p: 3, borderRadius: 4, display: "flex", flexDirection: "column", alignItems: "center", gap: 0.5 }}>
        ...
        <Typography sx={{ fontSize: 36, fontWeight: 600, color: "primary.main" }}>$48,000</Typography>
      </Box>
      <Box
        sx={(theme) => ({
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <Typography sx={{ fontSize: 14, color: "grey.800" }}>
            ...
            [Company Name]. By accessing or using the Marketplace, you agree to be bound by these Terms. If you do not agree to these Terms,
    ...
    >
      ...
      <LoadingButton sx={{ width: { xs: "100%", sm: "fit-content" } }} variant="contained">
        Submit
      </LoadingButton>
    </Box>
  </Box>
