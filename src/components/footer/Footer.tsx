  ...
  <Container>
    <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 2 }}>
        ...
        <Box sx={{ "&:hover > svg> circle": { fill: "black", fillOpacity: 1 }, "&:hover > svg> path": { fill: "white", fillOpacity: 1 } }}>
          <FbIcon />
        </Box>
        <Box sx={{ "&:hover > svg> circle": { fill: "black", fillOpacity: 1 }, "&:hover > svg> path": { fill: "white", fillOpacity: 1 } }}>
          <TwitterIcon />
    ...
    <Divider sx={{ my: 4 }} />
    <Box sx={{ display: "grid", gap: 2, rowGap: 4, gridTemplateColumns: { xs: "1fr 1fr", sm: "1fr 1fr 1fr", md: "1fr 1fr 1fr 1fr 1fr" } }}>
      {navs.map((el) => (
