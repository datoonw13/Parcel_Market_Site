...
const list = [
  ...
  },
  {
    ...
    description: `VOLT is extremely reliable and accurate in most areas. However, there are cases where data can be skewed, and VOLT is unable to filter outlier sales. This occurs most when large acreage transactions occur with multiple parcels and each individual parcel is assigned the overall sale value. Our team and statisticians are working to resolve this and make VOLT even more accurate. We will continue to improve VOLT for these cases and others to improve accuracy.`,
  },
  {
