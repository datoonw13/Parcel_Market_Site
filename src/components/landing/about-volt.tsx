...
const AboutVolt = () => (
  ...
  >
    <div className="space-y-2 md:space-y-3 max-w-3xl mx-auto">
      <h1 className="text-center font-extrabold text-2xl md:text-3xl lg:text-4xl xl:text-5xl">How Does Volt work?</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] items-center gap-6 md:gap-10 lg:gap-16 xl:gap-24">
      <div className="bg-error-100 h-56 sm:h-60 md:h-72 lg:h-80 xl:h-[400px] rounded-2xl">Video</div>
      <div className="h-fit space-y-2 md:space-y-3">
        <h1 className="font-bold text-xl sm:text-2xl md:text-3xl lg:font-extrabold lg:text-4xl xl:text-5xl">VOLT - Value of Land Tool</h1>
