        ...
        <div className="space-y-8">
          ...
          <div id="2" className="space-y-3 md:space-y-5">
            ...
            <ul className={cn("text-grey-800 text-sm list-disc [&>li]:ml-6", !modal && "md:text-base")}>
              <li>
                ...
                in connection with the Website. The services provided on our Website include, market data, property listings, chatrooms, and
                property value estimates based on comparable sales data. The Company is not a party to any transactions ultimately executed
                by users of the Website. Sales transactions are governed by the transactional documents executed by the parties.
              </li>
              <li>
          ...
          <div id="4" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm space-y-3", !modal && "md:text-base")}>
              ...
              <span>
                ...
                caution when accessing your account from a public or shared computer, or on a public network, so that others are not able to
          ...
          <div id="5" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm space-y-3", !modal && "md:text-base")}>
              ...
              <span>
                ...
                RAM incidental to your accessing and viewing those materials; (2) You may store files that are automatically cached by your
                Web browser for display enhancement purposes, (3) You may print or download one copy of a reasonable number of pages of the
                Website for your own personal, non-commercial use and not for further reproduction, publication, or distribution; and (4) If
                we provide desktop, mobile, or other applications for download, you may download a single copy to your computer or mobile
                device solely for your own personal use, provided you agree to be bound by our end user license agreement for such
                applications. You must not: (1) Modify copies of any materials from this site; (2) Use any illustrations, photographs, video
                or audio sequences, or any graphics separately from the accompanying text or (3) Delete or alter any copyright, trademark,
                or other proprietary rights notices from copies of materials from this site. If you print, copy, modify, download, or
                otherwise use or provide any other person with access to any part of the Website in breach of the Terms of Use, your right
                to use the Website will stop immediately and you must, at our option, return or destroy any copies of the materials you have
          ...
          <div id="7" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm", !modal && "md:text-base")}>
              ...
              non-proprietary. By posting photographs, videos, information, or any other content to our Website, you grant the Company, and
              our affiliates, a perpetual and royalty-free license and right to use, reproduce, modify, display, distribute, and otherwise
              disclose to third parties any such material for any purpose. By posting to our Website, you represent and warrant that you own
              the sole rights to any content that you post. You acknowledge that you are responsible for any content that you post to the
              Website, and you, not the Company, have full responsibility for such content, including its legality, reliability, accuracy,
              and appropriateness of any such content. We have the right to remove user contributions for any or no reason in our sole
              discretion and to terminate or suspend your access to all or part of the Website for any violation of these Terms of Use.
              ...
              Website. You agree to hold the Company harmless from any claims resulting from any action taking by any law enforcement
              authority, or any third-party, as a result of actions or inactions that you took while using our Website. The Company does not
              actively monitor the materials posted to our Website by users. The Company does not review material before it is posted and
              cannot ensure prompt removal of objectionable material. Accordingly, we assume no liability for any action or inaction
              regarding transmissions, communications, or content provided by any user or third party. If a user finds material posted to
              the Website offensive or objectionable, the user should notify the Company by sending an email to
          ...
          <div id="8" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm", !modal && "md:text-base")}>
              ...
              have no control over the contents of those sites or resources and accept no responsibility for them or for any loss or damage
              that may arise from your use of them. If you decide to access any of the third-party websites linked to this Website, you do
          ...
          <div id="9" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm", !modal && "md:text-base")}>
              ...
              outside of the United States. Access to the Website may not be legal by certain persons or in certain countries. If you access
              the Website from outside the United States, you do so on your own initiative and are responsible for compliance with local
              laws.
            </p>
          </div>
          <div id="10" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm space-y-3", !modal && "md:text-base")}>
              <span>
                ...
                maintaining a means external to our site for any reconstruction of any lost data. Your use of this Website, and its content
          ...
          <div id="11" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm space-y-3", !modal && "md:text-base")}>
              ...
              shall be governed by and construed in accordance with the internal laws of the State of Georgia, without giving effect to any
              choice or conflict of law provision or rule. Any legal suit, action, or proceeding arising out of, or related to, these Terms
              of Use or the Website shall be instituted exclusively in the courts of Jefferson County, Georgia, although we retain the right
              to bring any suit, action, or proceeding against you for breach of these Terms of Use in your country of residence or any
              other relevant country. You waive any and all objections to the exercise of jurisdiction over you by such courts and to venue
              in such courts. ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THESE TERMS OF USE OR THE WEBSITE MUST
              BE COMMENCED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES; OTHERWISE, SUCH CAUSE OF ACTION OR CLAIM IS PERMANENTLY
              BARRED. If any provision of these Terms of Use is held by a court or other tribunal of competent jurisdiction to be invalid,
              ...
              remaining provisions of the Terms of Use will continue in full force and effect. The Terms of Use and Privacy Policy
              constitute the sole and entire agreement between you and Parcel Market LLC regarding the Website and supersede all prior and
          ...
          <div id="12" className="space-y-3 md:space-y-5">
            ...
            <p className={cn("text-grey-800 text-sm space-y-3", !modal && "md:text-base")}>
              ...
              therein. All other feedback, comments, requests for technical support, and other communications relating to the Website should
              be directed to: <span className="font-semibold underline">customerservice@parcelmarket.com</span>.
            </p>
          </div>
        </div>
      </ScrollArea>
