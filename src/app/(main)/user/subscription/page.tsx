...
const UserProfileSubscription = async () => (
  <div className="w-full space-y-8">
    ...
    <PlanListWrapper className="sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sxl:grid-cols-2 [&>*>button:not(.subscribed):hover]:!text-white [&>*>button:not(.subscribed):hover]:!bg-primary-main" />
    <PaymentDetails />
  </div>
);
