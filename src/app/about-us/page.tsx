...
const AboutUs = () => {
  ...
  return (
    <Container sx={{ py: { xs: 10, md: 11, lg: 12.5 }, display: "flex", flexDirection: "column", gap: 4.5 }}>
      ...
      <Typography sx={{ fontSize: 14, color: "grey.800" }}>
        While the information provided by Parcel Market’s Value Of land Tool (VOLT) is the main driver behind our purpose, we also wanted to
        help our users utilize that information. We understand that the land business can be intimidating and finding qualified buyers,
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: 18, fontWeight: 700, width: { md: "max-content" } }}>The Parcel Market Purchase Option</Typography>
          </Box>
          <Typography sx={{ fontSize: 14, color: "grey.800" }}>
            ...
            and peace of mind, Parcel Market will pay a third-party attorney of your choice to review the purchase agreement on your behalf.
            ...
            your property. This option is ideal for sellers looking for a quick and hassle-free sale, prioritizing speed and convenience
